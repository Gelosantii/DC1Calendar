...
public class CalendarView
{
    ...
    public CalendarView(CalendarProgram program)
    {
        ...
        program.setBtnwrite(new JButton("Create an event"));
        ...
        program.getYearLabel().setBounds(360, 610, 160, 40);
        ...
        program.setYearBound(cal.get(GregorianCalendar.YEAR)); /////////////////////////////////////ANGELO NOTE THIS ONE
        ...
        program.getCalendarTable().getParent().setBackground(program.getCalendarTable().getBackground());
        ...
        for(int i = program.getYearBound(); i <= program.getYearBound(); i++)
        {
        ...
        program.getBtnPrev().addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                if (program.getMonthToday() == 0)
                {
                    ...
                    program.setYearToday(program.getYearToday() - 1);///////////////////////////////////////////////////NOTICE THIS
                }
                else
                {
        ...
        program.getBtnNext().addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                if (program.getMonthToday() == 11)
                {
                    ...
                    program.setYearToday(program.getYearToday() + 1);///////////////////////////////////////////////////////////AND THIS
                }
                else
                {
                    program.setMonthToday(program.getMonthToday() + 1);
